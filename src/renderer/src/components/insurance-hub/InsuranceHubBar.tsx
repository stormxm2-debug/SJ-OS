...
import { BookOpen, FileSearch, Link2, ListChecks, ReceiptText, Search, ShieldQuestion, Stethoscope, User, X } from 'lucide-react'
...
export type HubTool = 'insurance-analysis' | 'pre-underwriting' | 'underwriting' | 'claim-assistant' | 'wiki' | 'leads'
